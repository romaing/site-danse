...
export interface ApiDanseDanse extends Struct.CollectionTypeSchema {
  collectionName: 'danses';
  info: {
    displayName: 'Danse';
    pluralName: 'danses';
    singularName: 'danse';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::danse.danse'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Pages statiques du site (mentions l\u00E9gales, CGV, etc.)';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    categorie: Schema.Attribute.Enumeration<
      ['legales', 'informations', 'autres']
    > &
      Schema.Attribute.DefaultTo<'autres'>;
...
export interface ApiProfesseurProfesseur extends Struct.CollectionTypeSchema {
...
export interface ApiSeanceSeance extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    danse: Schema.Attribute.Relation<'manyToOne', 'api::danse.danse'>;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    description_longue: Schema.Attribute.RichText;
    horaire: Schema.Attribute.String & Schema.Attribute.Required;
    image: Schema.Attribute.Media<'images'>;
    jour_semaine: Schema.Attribute.Enumeration<
      ['lundi', 'mardi', 'mercredi', 'jeudi', 'vendredi', 'samedi', 'dimanche']
    > &
      Schema.Attribute.DefaultTo<'lundi'>;
    ...
    > &
      Schema.Attribute.DefaultTo<'debutant'>;
    prix_mensuel: Schema.Attribute.Decimal & Schema.Attribute.Required;
    professeur: Schema.Attribute.Relation<
      'manyToOne',
      'api::professeur.professeur'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::danse.danse': ApiDanseDanse;
      'api::page.page': ApiPagePage;
      'api::professeur.professeur': ApiProfesseurProfesseur;
